...
public class RegExpView extends ViewPart {
	...
	{
		setResultLabelImage(RegExpImages.RESULT_GRAY, "Validation not yet run");
	}
	...
	private void resultDoesNotMatch()
	{
		setResultLabelImage(RegExpImages.RESULT_RED, "Does not match");
	}

	private void resultMatches()
	{
		setResultLabelImage(RegExpImages.RESULT_GREEN, "Matches");
	}

	public void setResultLabelImage(ImageDescriptor descr, String tooltip) {
		...
		resultImageLabel.setToolTipText(tooltip);
	}
