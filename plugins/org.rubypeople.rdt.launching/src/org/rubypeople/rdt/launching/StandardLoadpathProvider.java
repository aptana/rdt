...
public class StandardLoadpathProvider implements IRuntimeLoadpathProvider {
	...
	/**
	 * Returns a collection of runtime loadpath entries that are defined in the
	 * specified attribute of the given launch configuration. When present,
	 * the attribute must contain a list of runtime loadpath entry mementos.
	 * 
	 * @param configuration launch configuration
	 * @param attribute attribute name containing the list of entries
	 * @return collection of runtime loadpath entries that are defined in the
