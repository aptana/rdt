...
//		 spell checking
		...
		PreferenceConverter.setDefault(store, IRubyColorConstants.RUBY_CLASS_VARIABLE, new RGB(0, 64, 128));
		store.setDefault(IRubyColorConstants.RUBY_CLASS_VARIABLE + PreferenceConstants.EDITOR_BOLD_SUFFIX, true);
		store.setDefault(IRubyColorConstants.RUBY_CLASS_VARIABLE + PreferenceConstants.EDITOR_ITALIC_SUFFIX, false);
