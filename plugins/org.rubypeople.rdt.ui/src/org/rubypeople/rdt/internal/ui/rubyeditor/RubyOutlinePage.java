 ...
 */
public class RubyOutlinePage extends Page implements IContentOutlinePage, IAdaptable , IPostSelectionProvider, ICustomRubyOutlinePage {
            ...
            protected class ChildrenProvider implements ITreeContentProvider {
                ...
                protected boolean matches(IRubyElement element) {
                    if (element.getElementType() == IRubyElement.BLOCK)
                    	return true;
                    return false;
                }
    ...
    public void createControl(Composite parent) {
        ...
        fOutlineViewer.setContentProvider(getContentProvider());
        fOutlineViewer.setLabelProvider(getLabelProvider());
