...
public abstract class OptionsConfigurationBlock {
	...
	protected final List<Button> fCheckBoxes;
	protected final List<Combo> fComboBoxes;
	protected final List<Text> fTextBoxes;
	protected final HashMap<Object, Label> fLabels;
	protected final List<ExpandableComposite> fExpandedComposites;
	...
	public OptionsConfigurationBlock(IStatusChangeListener context, IProject project, Key[] allKeys, IWorkbenchPreferenceContainer container) {
		...
		fLabels= new HashMap<Object, Label>();
	...
	protected Text addTextField(Composite parent, String label, Key key, int indent, int widthHint) {	
		Label labelControl= new Label(parent, SWT.WRAP | SWT.RIGHT);
		labelControl.setText(label);
		labelControl.setFont(JFaceResources.getDialogFont());
		labelControl.setLayoutData(new GridData());
