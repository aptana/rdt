...
public final class PreferencesMessages extends NLS {
	...
	public static String RubyEditorPreferencePage_instance_variables;
	public static String RubyEditorPreferencePage_class_variables;
	...
	public static String RubyBasePreferencePage_description;
	public static String RubyBasePreferencePage_doubleclick_action;
	public static String RubyBasePreferencePage_doubleclick_gointo;
	public static String RubyBasePreferencePage_doubleclick_expand;
	public static String RubyBasePreferencePage_search;
	public static String RubyBasePreferencePage_search_small_menu;
	public static String RubyBasePreferencePage_dialogs;
	public static String RubyBasePreferencePage_do_not_hide_description;
	public static String RubyBasePreferencePage_do_not_hide_button;
	public static String RubyBasePreferencePage_do_not_hide_dialog_title;
	public static String RubyBasePreferencePage_do_not_hide_dialog_message;
	public static String RubyEditorPreferencePage_subWordNavigation;
	public static String RubyEditorPreferencePage_quickassist_lightbulb;
	...
	public static String RubyEditorPreferencePage_insertSingleProposalsAutomatically;
	public static String RubyEditorPreferencePage_completePrefixes;
	public static String RubyEditorPreferencePage_fillArgumentNamesOnMethodCompletion;
	public static String RubyEditorPreferencePage_fillBlockArgumentNamesOnMethodCompletion;
	public static String RubyEditorPreferencePage_presentProposalsInAlphabeticalOrder;
	...
	public static String RubyEditorPreferencePage_enableAutoActivation;
	public static String RubyEditorPreferencePage_autoActivationDelay;
	public static String RubyEditorPreferencePage_completionInserts;
	public static String RubyEditorPreferencePage_completionOverwrites;
