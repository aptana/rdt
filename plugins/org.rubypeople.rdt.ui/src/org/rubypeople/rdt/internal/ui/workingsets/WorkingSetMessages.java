...
public class WorkingSetMessages extends NLS {
	...
	public static String RubyWorkingSetPage_title;
	public static String RubyWorkingSetPage_workingSet_description;
	public static String RubyWorkingSetPage_workingSet_name;
	public static String RubyWorkingSetPage_workingSet_content;
	public static String RubyWorkingSetPage_selectAll_label;
	public static String RubyWorkingSetPage_selectAll_toolTip;
	public static String RubyWorkingSetPage_deselectAll_label;
	public static String RubyWorkingSetPage_deselectAll_toolTip;
	public static String RubyWorkingSetPage_warning_nameWhitespace;
	public static String RubyWorkingSetPage_warning_nameMustNotBeEmpty;
	public static String RubyWorkingSetPage_warning_workingSetExists;
	public static String RubyWorkingSetPage_warning_resourceMustBeChecked;	
