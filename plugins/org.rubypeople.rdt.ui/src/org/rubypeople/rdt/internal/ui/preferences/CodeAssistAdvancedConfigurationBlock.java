...
import org.rubypeople.rdt.internal.ui.text.ruby.CompletionProposalCategory;
...
final class CodeAssistAdvancedConfigurationBlock extends OptionsConfigurationBlock {
	...
	private static final Key PREF_EXCLUDED_CATEGORIES= getRDTUIKey(PreferenceConstants.CODEASSIST_EXCLUDED_CATEGORIES);
	private static final Key PREF_CATEGORY_ORDER= getRDTUIKey(PreferenceConstants.CODEASSIST_CATEGORY_ORDER);
	...
	private final class ModelElement {
		...
		ModelElement(CompletionProposalCategory category, PreferenceModel model) {
			...
			fCommand= commandSvc.getCommand("org.rubypeople.rdt.ui.specific_content_assist.command"); //$NON-NLS-1$
			IParameter type;
			try {
