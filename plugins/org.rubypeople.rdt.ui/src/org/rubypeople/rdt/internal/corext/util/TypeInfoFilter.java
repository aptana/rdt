...
public class TypeInfoFilter {
	...
	public int getSearchFlags() {
		if (fNamespaceMatcher != null) {
			...
			// FIXME I have no idea what to do here. We need to change the match rule for the simple name and the enclosing type names independently the way the API is set up, but here we can only pass in one flag
