...
public class ConstructorOffsetProvider extends OffsetProvider {
	...
	public Node getInsertAfterNode() {
		...
		if (contentNode != null) {
			if (NodeProvider.hasChildNode(contentNode, DefnNode.class)) {
				...
				Collection<MethodNodeWrapper> constructors = classPart.getExistingConstructors();
			...
			return getLastContentNode(classPart);
