...
public class AttrFieldItem extends FieldItem {

	private SymbolNode symbol;
	
	public AttrFieldItem(SymbolNode symbol) {
		this.symbol = symbol;
	}

	@Override
	public String getFieldName() {
		return fieldName(symbol.getName());
	}
	...
	public Node getRenamedNode(String newName) {
		return new SymbolNode(symbol.getPosition(), newName);
	}
