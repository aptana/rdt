...
public class MoveFieldRefactoring extends RubyRefactoring {
	...
	public MoveFieldRefactoring(IRefactoringContext selectionProvider) {
		super(NAME, selectionProvider);

		MoveFieldConfig config = new MoveFieldConfig(new DocumentWithIncluding(getDocumentProvider()), selectionProvider.getCaretPosition());
