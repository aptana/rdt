...
public class InlineAndRemoveEditProvider extends MultiEditProvider implements IRemoveDeclaration {
	
	private final InlineMethodConfig config;
	private boolean remove;

	public InlineAndRemoveEditProvider(InlineMethodConfig config) {
		this.config = config;
	}
