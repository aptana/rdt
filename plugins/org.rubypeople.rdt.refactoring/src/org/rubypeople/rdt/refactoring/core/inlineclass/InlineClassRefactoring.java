...
public class InlineClassRefactoring extends RubyRefactoring{
	...
	public InlineClassRefactoring(IRefactoringContext selectionProvider) {
		super(NAME, selectionProvider);
		
		InlineClassConfig config = new InlineClassConfig(getDocumentProvider(), selectionProvider.getCaretPosition());
