...
public class SplitTempRefactoring extends RubyRefactoring {
	...
	public SplitTempRefactoring(IRefactoringContext selectionProvider) {
		super(NAME, selectionProvider);

		SplitLocalConfig config = new SplitLocalConfig(getDocumentProvider(), selectionProvider.getCaretPosition());
