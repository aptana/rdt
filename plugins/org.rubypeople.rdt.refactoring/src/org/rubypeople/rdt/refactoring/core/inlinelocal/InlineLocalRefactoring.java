...
public class InlineLocalRefactoring extends RubyRefactoring {
	...
	public InlineLocalRefactoring(IRefactoringContext selectionProvider) {
		super(NAME, selectionProvider);
		
		InlineLocalConfig config = new InlineLocalConfig(getDocumentProvider(), selectionProvider.getCaretPosition());
