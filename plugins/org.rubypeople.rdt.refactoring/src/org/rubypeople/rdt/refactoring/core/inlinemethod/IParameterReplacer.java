...
/**
 * Replaces all parameters in the method definition with the corresponding variables from the call.
 * If some call arguments aren't variables but values, they are assigned and inserted before the 
 * body of the method.
