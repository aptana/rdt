...
public class InstVarFieldItem extends FieldItem {


	private InstVarNode instVarNode;
	public InstVarFieldItem(InstVarNode instVarNode) {
		this.instVarNode = instVarNode;
	}

	@Override
	public String getFieldName() {
		return fieldName(instVarNode.getName());
	}
