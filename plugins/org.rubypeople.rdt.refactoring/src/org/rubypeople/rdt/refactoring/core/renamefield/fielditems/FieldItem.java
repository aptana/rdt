...
public abstract class FieldItem implements INodeWrapper{
	
	public abstract Node getFieldNode();
	
	public abstract Node getRenamedNode(String newName);
	
	public abstract String getFieldName();

	protected String setPrefixName(String newName, String prefix) {
