...
public class AccessorFieldItem extends FieldItem {

	private AttrAccessorNodeWrapper currentAccessor;
	public AccessorFieldItem(AttrAccessorNodeWrapper currentAccessor) {
	...
	public String getFieldName() {
		return currentAccessor.getAttrName();
	}
