...
public class SingleLocalVariableEdit extends ReplaceEditProvider {
	...
	public int getOffsetLength() {
		return node.getPositionIncludingComments().getEndOffset() - getStartOffset();
	}
	...
	{
		if (node instanceof RestArgNode)
		{
			return node.getPositionIncludingComments().getStartOffset() + 1;
		}
