...
public class EncapsulateFieldRefactoring extends RubyRefactoring {
	...
	public EncapsulateFieldRefactoring(IRefactoringContext selectionProvider) {
		super(NAME, selectionProvider);

		EncapsulateFieldConfig config = new EncapsulateFieldConfig(getDocumentProvider(), selectionProvider.getCaretPosition());
