...
public class ExtractMethodRefactoring extends RubyRefactoring {
	...
	public ExtractMethodRefactoring(RefactoringContext selectionProvider) {
		super(NAME, selectionProvider);
		
		ExtractMethodConfig config = new ExtractMethodConfig(getDocumentProvider(), selectionProvider);
		...
		if(checker.shouldPerform()) {
			...
			UserInputWizardPage page = new ExtractMethodPage(methodExtractor, selectionProvider);
			pages.add(page);
		}
	}
}
