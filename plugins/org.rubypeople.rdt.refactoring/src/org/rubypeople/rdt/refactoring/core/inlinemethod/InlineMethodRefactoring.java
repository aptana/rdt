...
public class InlineMethodRefactoring extends RubyRefactoring {
	...
	public InlineMethodRefactoring(IRefactoringContext selectionProvider) {
		super(NAME, selectionProvider);
		
		InlineMethodConfig config = new InlineMethodConfig(getDocumentProvider(), selectionProvider.getCaretPosition(), new TargetClassFinderUI());
