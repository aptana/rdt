...
public class ClassVarFieldItem extends FieldItem {

	private ClassVarNode classVarNode;
	
	public ClassVarFieldItem(ClassVarNode classVarNode) {

		this.classVarNode = classVarNode;
	}

	@Override
	public String getFieldName() {
		return fieldName(classVarNode.getName());
	}
