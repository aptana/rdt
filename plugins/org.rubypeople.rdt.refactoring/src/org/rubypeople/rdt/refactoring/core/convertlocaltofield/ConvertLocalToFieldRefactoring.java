...
public class ConvertLocalToFieldRefactoring extends RubyRefactoring {
	...
	public ConvertLocalToFieldRefactoring(IRefactoringContext selectionProvider) {
		super(NAME, selectionProvider);

		LocalToFieldConfig config = new LocalToFieldConfig(getDocumentProvider(), selectionProvider.getCaretPosition());
