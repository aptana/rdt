...
public class InsertVisibilityEditProvider extends InsertEditProvider {

	private METHOD_VISIBILITY visibility;
	private MethodNodeWrapper methodNode;

	public InsertVisibilityEditProvider(MethodNodeWrapper methodNode, METHOD_VISIBILITY visibility) {
		super(true);
	...
	protected Node getInsertNode(int offset, String document) {
		...
		Node visibilityNode = NodeFactory.createVisibilityNode(visibility, methodNode.getName());
		return NodeFactory.createBlockNode(false, needsNewLineAtEndOfBlock, visibilityNode);
	}

	@Override
	protected int getOffset(String document) {
		IOffsetProvider offsetProvider = new AfterNodeOffsetProvider(methodNode.getWrappedNode(), document);
