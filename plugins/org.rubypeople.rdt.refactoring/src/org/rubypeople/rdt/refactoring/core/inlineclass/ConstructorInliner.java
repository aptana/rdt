...
public class ConstructorInliner extends InsertEditProvider
{
	...
	protected Node getInsertNode(int offset, String document)
	{
		...
		MethodDefNode inlinedConstructor = NodeFactory.createMethodNode(newName, constructor.getArgsNode(), constructor
				.getBodyNode());
	...
	{
		BeforeFirstMethodInClassOffsetProvider offsetProvider = new BeforeFirstMethodInClassOffsetProvider(targetClass,
				document);
