...
public class ClassNodeSignatureProvider extends ClassSignatureProvider {
	...
	public ClassNodeSignatureProvider(ClassNodeWrapper classNode, ClassNodeProvider classNodeProvider) {
		super(getSuperProvider(classNode, classNodeProvider));
		this.classNode = classNode;
		createMethodSignatures();
	}

	private void createMethodSignatures() {
		Collection<MethodNodeWrapper> methods = classNode.getMethods();
		for (MethodNodeWrapper method : methods) {
			addMethodSignature(method.getName(), method);
		}
	}
