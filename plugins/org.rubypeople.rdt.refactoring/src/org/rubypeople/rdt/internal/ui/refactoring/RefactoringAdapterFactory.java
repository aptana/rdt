...
import org.rubypeople.rdt.internal.corext.refactoring.changes.MultiStateRubyScriptChange;
...
public class RefactoringAdapterFactory implements IAdapterFactory {
	...
	public Object getAdapter(Object object, Class key) {
		if (!TextEditChangeNode.class.equals(key))
			return null;
		if (!(object instanceof RubyScriptChange) && !(object instanceof MultiStateRubyScriptChange))
			return null;
		return new RubyScriptChangeNode((TextEditBasedChange)object);
	}
}
