...
public class DeleteFileChange extends RDTChange {
	...
	public DeleteFileChange(IFile file) {
		...
		fPath = file.getFullPath().removeFirstSegments(
	...
	public Change perform(IProgressMonitor pm) throws CoreException {
		try {
			...
			CreateFileChange undo = createUndoChange(file, fPath, file
					.getModificationStamp(), fSource);
	...
	private static CreateFileChange createUndoChange(IFile file, IPath path,
			long stampToRestore, String source) {
		String encoding;
		try {
