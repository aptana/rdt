...
package org.rubypeople.rdt.refactoring.tests.core.renameclass.conditionchecker;
...
public class RenameClassConditionTester extends RefactoringConditionTestCase {

	private FilePropertyData testData;
	private RenameClassConfig renameClassConfig;

	public RenameClassConditionTester(String fileName) {
		super(fileName);
	}
	...
	public void runTest() throws FileNotFoundException, IOException {
		...
		renameClassConfig = new RenameClassConfig(testData, testData.getIntProperty("caretPosition"));
		RenameClassConditionChecker checker = new RenameClassConditionChecker(renameClassConfig);
	...
	protected void createEditProviderAndSetUserInput() {
		new RenameClassEditProvider(renameClassConfig);
	}
}
