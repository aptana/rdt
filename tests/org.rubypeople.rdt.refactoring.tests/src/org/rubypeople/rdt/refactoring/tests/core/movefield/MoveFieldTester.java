...
package org.rubypeople.rdt.refactoring.tests.core.movefield;
...
public class MoveFieldTester extends RefactoringTestCase {
	...
	public void runTest() throws FileNotFoundException, IOException, BadLocationException {
		...
		config.setTargetClass(testData.getProperty("selectedClass"));
		config.setTargetReference(testData.getProperty("selectedReference"));
