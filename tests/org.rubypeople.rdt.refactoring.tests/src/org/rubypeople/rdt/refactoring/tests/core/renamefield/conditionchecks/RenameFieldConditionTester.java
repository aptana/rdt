...
package org.rubypeople.rdt.refactoring.tests.core.renamefield.conditionchecks;
...
public class RenameFieldConditionTester extends RefactoringConditionTestCase {


	private FilePropertyData testData;
	private RenameFieldConfig config;

	public RenameFieldConditionTester(String fileName) {
		super(fileName);
	}
	...
	public void runTest() throws FileNotFoundException, IOException {
		...
		config = new RenameFieldConfig(testData, testData.getIntProperty("caretPosition"));
		RenameFieldConditionChecker checker = new RenameFieldConditionChecker(config);
