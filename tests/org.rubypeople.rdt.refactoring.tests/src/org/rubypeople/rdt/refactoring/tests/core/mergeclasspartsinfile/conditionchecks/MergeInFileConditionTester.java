...
package org.rubypeople.rdt.refactoring.tests.core.mergeclasspartsinfile.conditionchecks;
...
public class MergeInFileConditionTester extends RefactoringConditionTestCase {

	private MergeClassPartInFileConfig config;

	public MergeInFileConditionTester(String fileName) {
		super(fileName);
	}
	...
	protected void createEditProviderAndSetUserInput() {
		new InFileClassPartsMerger(config);
	}
}
