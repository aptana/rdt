...
package org.rubypeople.rdt.refactoring.tests.core.inlinemethod.conditions;
...
public class InlineMethodConditionTester extends RefactoringConditionTestCase {

	public InlineMethodConditionTester(String fileName) {
		super(fileName);
	}
