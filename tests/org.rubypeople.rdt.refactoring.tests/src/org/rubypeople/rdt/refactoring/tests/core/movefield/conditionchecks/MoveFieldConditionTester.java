...
package org.rubypeople.rdt.refactoring.tests.core.movefield.conditionchecks;

import java.io.FileNotFoundException;
import java.io.IOException;

import org.rubypeople.rdt.refactoring.core.movefield.MoveFieldConditionChecker;
import org.rubypeople.rdt.refactoring.core.movefield.MoveFieldConfig;
import org.rubypeople.rdt.refactoring.core.movefield.MoveFieldEditProvider;
...
public class MoveFieldConditionTester extends RefactoringConditionTestCase {
	
	private MoveFieldConfig config;
	private FilePropertyData testData;

	public MoveFieldConditionTester(String fileName) {
		super(fileName);
	}
	...
	protected void createEditProviderAndSetUserInput() {
		new MoveFieldEditProvider(config);
	}
}
