...
package org.rubypeople.rdt.refactoring.tests.core.encapsulatefield.conditionchecks;
...
public class EncapsulateFieldConditionTester extends RefactoringConditionTestCase {


	private EncapsulateFieldConfig config;

	public EncapsulateFieldConditionTester(String fileName) {
		super(fileName);
	}
